...
if (NpixelData[0] == 0 && y > 0) {directions = directions + "N";}
if (SpixelData[0] == 0 && y < 50) {directions = directions + "S";}
if (EpixelData[0] == 0 && x < 50) {directions = directions + "E";}
if (WpixelData[0] == 0 && x > 0) {directions = directions + "W";}
return directions;
}
...
while (ourDirections.length == 0 && document.DoneDoneDone == 0) {
 if (history.length == 1) {document.DoneDoneDone = 1;};
 go = history.slice(-1); 
...
if (document.DoneDoneDone == 0) {
 var t=setTimeout(function(){step()},1)


}
}
if (document.DoneDoneDone == 0) {step();}
